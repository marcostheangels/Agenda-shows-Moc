...
Site profissional para divulgação de shows, forró, bares e restaurantes de Montes Claros - MG.

## 📁 Arquivos
- `index.html` - Página principal do site
- `styles.css` - Estilos do site
- `script.js` - JavaScript do site
- `admin.html` - **Painel administrativo (login protegido)**
...
- Adicionar descrição, categoria e visual

### 📁 Categorias
- Criar/editar/excluir categorias
- Personalizar ícone (emoji), slug e cor

### 📰 Blog
- Publicar notícias e matérias
- Definir categoria, data, imagem e resumo
